      ...
      <main className="bg-black flex flex-col items-center justify-center h-screen font-gspFont">
        ...
        <div className="h-screen md:w-screen">
          <video
            ...
            loop
            autoPlay
            className=" h-screen md:w-screen object-cover object-left md:object-center overflow-hidden z-0 pointer-events-none"
          ></video>
        </div>
        {/* Grid Navigation */}
        <div className="fixed z-30 w-full h-screen flex flex-col items-center justify-center  duration-100">
